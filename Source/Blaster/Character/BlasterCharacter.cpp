...
void ABlasterCharacter::MulticastElim_Implementation()
{
	...
	{
		DynamicDissolveMaterialInstance = UMaterialInstanceDynamic::Create(DissovleMaterialInstance, this);
...
float ABlasterCharacter::CalulateSpeed()
{
