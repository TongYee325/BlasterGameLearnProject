...
{
	if (EquippedWeapon == nullptr || !EquippedWeapon->GetbUseZoom())return;

	if (bAiming)
	{
		CurrentFOV = FMath::FInterpTo(CurrentFOV, EquippedWeapon->GetZoomedFOV(), DeltaTime, EquippedWeapon->GetZoomInterpSpped());
	}
	else
	{
